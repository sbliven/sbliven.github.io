...
I work at the intersection of scientific computing, bioinformatics, and open science.

Check out my [Github Profile](https://github.com/sbliven)!

## Projects

### OpenEM

[OpenEM](https://www.openem.ch/) is an open research data infrastructure for Swiss electron microscopy facilities. It uses the [PSI Data Catalog](https://discovery.psi.ch) to catalog image datasets, and is built on the [SciCat](https://www.scicatproject.org/) data catalog.

### TRAL

The [Tandem Repeat Annotation Library (TRAL)](https://github.com/acg-team/tral) is a method for detecting repeats in protein sequences.

> **TRAL 2.0: Tandem Repeat Detection with Circular Profile Hidden Markov Models and Evolutionary Aligner.**<br/>
> _Delucchi, M., Näf, P., Bliven, S., & Anisimova, M._
> [Frontiers in Bioinformatics (2021)  1:691865.](https://doi.org/10.3389/fbinf.2021.691865)
> {% include doi.html doi="10.3389/fbinf.2021.691865" %}

### EPPIC

The [Evolutionary Protein Protein Interface Classifier (EPPIC)](eppic-web.org) is a software package for the analysis of interfaces in protein crystal structures and for quaternary structure prediction. [github](https://github.com/eppic-team/eppic)

> **Automated evaluation of quaternary structures from protein crystals.**<br/>
> _Bliven S, Lafita A, Parker A, Capitani G, Duarte JM_<br/>
> [PLoS Comput Biol (2018) 14(4): e1006104.](https://doi.org/10.1371/journal.pcbi.1006104)<br/>
> {% include doi.html doi="10.1371/journal.pcbi.1006104" %}

### Protein structural alignment algorithms

These algorithms are discussed in my PhD thesis from UC San Diego under Prof. Philip Bourne.

> [Structure-Preserving Rearrangements: Algorithms for Structural Comparison and Protein Analysis](https://www.proquest.com/openview/66848a5f702b91ce5b7b43f2356bcde1/1?pq-origsite=gscholar&cbl=18750)
...
> **Structure of the Full-length VEGFR-1 Extracellular Domain in Complex with VEGF-A**<br/>
> _Sandra Markovic-Mueller, Edward Stuttfeld, Mayanka Asthana, Tobias Weinert, Spencer Bliven, Kenneth N. Goldie, Kaisa Kisko, Guido Capitani, Kurt Ballmer-Hofer_<br/>
> [Structure (2017) 25: 2, 341-352](https://doi.org/10.1016/j.str.2016.12.012)<br/>
> {% include doi.html doi="10.1016/j.str.2016.12.012" %}
> {% include pubmed.html pmid="28111021" %}
